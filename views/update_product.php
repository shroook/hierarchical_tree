    ...
    ?>	
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <input type="file" name="product_image"  accept=".png,.gif,.jpg,.webp" value=" <?php '<img src="data:image/jpeg;base64,'.base64_encode($row['product_image'] ).'"/>'?>">
                  <td >
                    
 <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['product_image'] ).'" height="70" width="70"/>'?>
 </td>
